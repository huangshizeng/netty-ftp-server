...
import com.fgi.ftp.common.FtpType;
import com.fgi.ftp.exception.CommandException;
...
public class ServerHandler extends SimpleChannelInboundHandler<String> {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        send(CODE_CONNECT_SUCCESS, "FTP server ready.", ctx);
    }
     ...
     */
    public void command_user(String line, StringTokenizer st, ChannelHandlerContext ctx) {
